...
object TypeStringCompat {
  ...
  //        about the argument types of a given type. As such, for example, we won't have different type strings for
  //        HLists of the same size but different types with this implementation.
