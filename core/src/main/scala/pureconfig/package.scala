...
package object pureconfig {
  ...
  def loadConfig[A](path: Path, namespace: String)(implicit reader: Derivation[ConfigReader[A]]): ConfigReader.Result[A] =
  ...
  def loadConfig[A](conf: Config, namespace: String)(implicit reader: Derivation[ConfigReader[A]]): ConfigReader.Result[A] =
   ...
   *         isn't possible
   */
  @deprecated("Use `ConfigSource.fromConfig(conf).withFallback(ConfigSource.default).at(namespace).load[A]` instead", "0.12.0")
  def loadConfigWithFallback[A](conf: Config, namespace: String)(implicit reader: Derivation[ConfigReader[A]]): ConfigReader.Result[A] =
   ...
   */
  @throws[ConfigReaderException[_]]
  @deprecated("Use `ConfigSource.fromConfig(conf).withFallback(ConfigSource.default).at(namespace).loadOrThrow[A]` instead", "0.12.0")
  def loadConfigWithFallbackOrThrow[A: ClassTag](conf: Config, namespace: String)(implicit reader: Derivation[ConfigReader[A]]): A =
  ...
  def saveConfigAsPropertyFile[A](
    ...
    options: ConfigRenderOptions = ConfigRenderOptions.defaults())(implicit writer: Derivation[ConfigWriter[A]]): Unit = {
  ...
  def loadConfigFromFiles[A](files: Traversable[Path], failOnReadError: Boolean = false, namespace: String = "")(implicit reader: Derivation[ConfigReader[A]]): ConfigReader.Result[A] = {
  ...
  @throws[ConfigReaderException[_]]
  @deprecated("Construct a custom `ConfigSource` pipeline instead", "0.12.0")
  def loadConfigFromFilesOrThrow[A: ClassTag](files: Traversable[Path])(implicit reader: Derivation[ConfigReader[A]]): A = {
    ConfigSource.default(
